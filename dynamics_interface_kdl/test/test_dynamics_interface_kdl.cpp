...
{
public:
  std::shared_ptr<pluginlib::ClassLoader<dynamics_interface::DynamicsInterface>> ik_loader_;
  std::shared_ptr<dynamics_interface::DynamicsInterface> ik_;
  ...
  void SetUp()
  {
    ...
    ik_ = std::unique_ptr<dynamics_interface::DynamicsInterface>(
